...
class PolicyGradient:
    ...
    def learn(self, observation):
        ...
        # current_step = 0
        # for current_step in range(0,13):
        for current_step in range(0,13):
        ...
        # one_hot_action[0][0] one_hot_action[0][1] one_hot_action[1][0] one_hot_action[1][1]   is 1  0  0  1
            ...
            delta_layer2_w11 = (diff_soft[0][0] + diff_soft[1][0]) * self.layer1_output[current_step][0]
            delta_layer2_w12 = (diff_soft[0][1] + diff_soft[1][1]) * self.layer1_output[current_step][0]


            delta_layer2_w21 = (diff_soft[0][0] + diff_soft[1][0]) * self.layer1_output[current_step][1]
            delta_layer2_w22 = (diff_soft[0][1] + diff_soft[1][1]) * self.layer1_output[current_step][1]

            delta_layer2_w31 = (diff_soft[0][0] + diff_soft[1][0]) * self.layer1_output[current_step][2]
            delta_layer2_w32 = (diff_soft[0][1] + diff_soft[1][1]) * self.layer1_output[current_step][2]


            delta_layer2_w41 = (diff_soft[0][0] + diff_soft[1][0]) * self.layer1_output[current_step][3]
            delta_layer2_w42 = (diff_soft[0][1] + diff_soft[1][1]) * self.layer1_output[current_step][3]
            ...
            # please see the note book, the first example for w11 in the first layer
            delta_layer1_w11[current_step] =  ((diff_soft[0][0] + diff_soft[1][0]) * weight2[0][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[0][1])*tanh_delta0*x1
            delta_layer1_w12[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[1][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[1][1])*tanh_delta1*x1
            delta_layer1_w13[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[2][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[2][1])*tanh_delta2*x1
            delta_layer1_w14[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[3][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[3][1])*tanh_delta3*x1



            delta_layer1_w21[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[0][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[0][1])*tanh_delta0*x2
            #  actually the w21 is more close to the w11, we should keep them together     

            delta_layer1_w22[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[1][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[1][1])*tanh_delta1*x2
            delta_layer1_w23[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[2][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[2][1])*tanh_delta2*x2
            delta_layer1_w24[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[3][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[3][1])*tanh_delta3*x2



            delta_layer1_w31[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[0][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[0][1])*tanh_delta0*x3
            delta_layer1_w32[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[1][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[1][1])*tanh_delta1*x3
            delta_layer1_w33[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[2][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[2][1])*tanh_delta2*x3
            delta_layer1_w34[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[3][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[3][1])*tanh_delta3*x3


            delta_layer1_w41[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[0][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[0][1])*tanh_delta0*x4
            delta_layer1_w42[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[1][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[1][1])*tanh_delta1*x4
            delta_layer1_w43[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[2][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[2][1])*tanh_delta2*x4
            delta_layer1_w44[current_step]  = ((diff_soft[0][0] + diff_soft[1][0]) * weight2[3][0] +  (diff_soft[0][1] + diff_soft[1][1]) * weight2[3][1])*tanh_delta3*x4
        ...
        # change the step num here to 13 in near future
            ...
            print ("***********************  in the current", current_step, "step updating weights  ******************")
        ...
        # the for loop will operate from 0 to 1    
            ...
            for num in range(0,step_num):
                ...
                print ("the delta_layer1_w11[num]is :", delta_layer1_w11[num] )
            ...
            # end of the for loop for 13 steps
    ...
    def _discount_and_norm_rewards(self):
        ...
        # 
        discounted_ep_rs = [ 5.5203495,   4.6339645,   3.7386262,   2.8342443,   1.920727,    0.99798226 ,  0.06591693, -0.8755632,  -1.8265532,  -2.7871492,  -3.7574482,  -4.7375484, -5.727548  ]
